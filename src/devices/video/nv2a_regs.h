...
#define NV_PGRAPH_DEBUG_3                                0x0000008C    //***NOT USED , only get, no set
...
#define NV_PGRAPH_NSOURCE                                0x00000108    //***NOT USED, only set in NV097_NO_OPERATION when arg0!=0, no get
#   define NV_PGRAPH_NSOURCE_NOTIFICATION                     (1 << 0)
#define NV_PGRAPH_INTR_EN                                0x00000140    //***could be replaced by an state var. only store state in REAR32/WRITE32(PGRAPH)
...
#define NV_PGRAPH_CTX_USER                               0x00000148   //***could be replaced by an state var, read and set by WRITE32(PGRAPH), read and checked by pgraph_switch_context() which was called by pfifo_run_puller() prior to calling prgaph_handle_method(). but pfifo_run_puller() is no longer used.
...
#define NV_PGRAPH_CTX_SWITCH1                            0x0000014C    //***NOT USED, only set, no get in pgraph_handle_method()
...
#define NV_PGRAPH_CTX_SWITCH2                            0x00000150    //***NOT USED, only set, no get in pgraph_handle_method()
#define NV_PGRAPH_CTX_SWITCH3                            0x00000154    //***NOT USED, only set, no get in pgraph_handle_method()
#define NV_PGRAPH_CTX_SWITCH4                            0x00000158    //***NOT USED, only set, no get in pgraph_handle_method()
#   define NV_PGRAPH_CTX_SWITCH4_USER_INSTANCE                0x0000FFFF
#define NV_PGRAPH_CTX_SWITCH5                            0x0000015C    //***NOT USED, only set, no get in pgraph_handle_method()
#define NV_PGRAPH_CTX_CACHE1                             0x00000160    //*** could be replace by state var[]. only set immediate get in pgraph_handle_method()
#define NV_PGRAPH_CTX_CACHE2                             0x00000180    //*** could be replace by state var[]. only set immediate get in pgraph_handle_method()
#define NV_PGRAPH_CTX_CACHE3                             0x000001A0    //*** could be replace by state var[]. only set immediate get in pgraph_handle_method()
#define NV_PGRAPH_CTX_CACHE4                             0x000001C0    //*** could be replace by state var[]. only set immediate get in pgraph_handle_method()
#define NV_PGRAPH_CTX_CACHE5                             0x000001E0    //*** could be replace by state var[]. only set immediate get in pgraph_handle_method()
#define NV_PGRAPH_STATUS                                 0x00000700
#define NV_PGRAPH_TRAPPED_ADDR                           0x00000704    //NOT USED***only set, no get, in pgraph_handle_method()X3 and pgraph_switch_context()X1
...
#define NV_PGRAPH_TRAPPED_DATA_LOW                       0x00000708    //NOT USED***only set, no get, in pgraph_handle_method()X1
...
#define NV_PGRAPH_INCREMENT                              0x0000071C    //***NOT USED, only use as address for switch in WRITE32(PGRAPH)
#   define NV_PGRAPH_INCREMENT_READ_BLIT                        (1 << 0)
#   define NV_PGRAPH_INCREMENT_READ_3D                          (1 << 1)
#define NV_PGRAPH_FIFO                                   0x00000720    //***NOT USED, only use as address for switch in WRITE32(PGRAPH),not set, only get. and read chand checked by pgraph_wait_fifo_access(NV2AState *d)
#   define NV_PGRAPH_FIFO_ACCESS                                (1 << 0)
#define NV_PGRAPH_RDI_INDEX                              0x00000750    //***used in READ32/WRITE32(PGRAPH), could be replaced by state var.
#   define NV_PGRAPH_RDI_INDEX_ADDRESS                        0x00001FFC
#   define NV_PGRAPH_RDI_INDEX_SELECT                         0x01FF0000
#define NV_PGRAPH_RDI_DATA                               0x00000754    //***NOT USED, only used as address for switch in READ32/WRITE32(PGRAPH)
...
#           define NV097_SET_COMBINER_SPECULAR_FOG_CW0_B_SOURCE_REG_SPECLIT 0xE<<16
#           define NV097_SET_COMBINER_SPECULAR_FOG_CW0_B_SOURCE_REG_EF_PROD 0xF<<16
...
#           define NV097_SET_COMBINER_SPECULAR_FOG_CW0_D_SOURCE_REG_C       0xC
...
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_0        0x00000000<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_1        0x00000001<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_2        0x00000002<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_3        0x00000003<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_4        0x00000004<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_5        0x00000005<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_8        0x00000008<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_9        0x00000009<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_A        0x0000000A<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_B        0x0000000B<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_C        0x0000000C<<24
#       define NV097_SET_COMBINER_COLOR_ICW_A_SOURCE_REG_D        0x0000000D<<24
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP                 0x00E00000
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_UNSIGNED_IDENTITY                0x00000000<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_UNSIGNED_INVERT                  0x00000001<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_EXPAND_NORMAL                    0x00000002<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_EXPAND_NEGATE                    0x00000003<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_HALFBIAS_NORMAL                  0x00000004<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_HALFBIAS_NEGATE                  0x00000005<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_SIGNED_IDENTITY                  0x00000006<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_MAP_SIGNED_NEGATE                    0x00000007<<21
#       define NV097_SET_COMBINER_COLOR_ICW_B_ALPHA               (1<<20)
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE              0x000F0000
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_0        0x00000000<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_1        0x00000001<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_2        0x00000002<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_3        0x00000003<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_4        0x00000004<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_5        0x00000005<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_8        0x00000008<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_9        0x00000009<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_A        0x0000000A<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_B        0x0000000B<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_C        0x0000000C<<16
#       define NV097_SET_COMBINER_COLOR_ICW_B_SOURCE_REG_D        0x0000000D<<16
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP                 0x0000E000
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_UNSIGNED_IDENTITY                0x00000000<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_UNSIGNED_INVERT                  0x00000001<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_EXPAND_NORMAL                    0x00000002<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_EXPAND_NEGATE                    0x00000003<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_HALFBIAS_NORMAL                  0x00000004<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_HALFBIAS_NEGATE                  0x00000005<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_SIGNED_IDENTITY                  0x00000006<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_MAP_SIGNED_NEGATE                    0x00000007<<13
#       define NV097_SET_COMBINER_COLOR_ICW_C_ALPHA               (1<<12)
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE              0x00000F00
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_0        0x00000000<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_1        0x00000001<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_2        0x00000002<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_3        0x00000003<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_4        0x00000004<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_5        0x00000005<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_8        0x00000008<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_9        0x00000009<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_A        0x0000000A<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_B        0x0000000B<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_C        0x0000000C<<8
#       define NV097_SET_COMBINER_COLOR_ICW_C_SOURCE_REG_D        0x0000000D<<8
...
#           define NV097_SET_TEXTURE_FORMAT_DIMENSIONALITY_SHIFT  0x00000004
...
#       define NV097_SET_TEXTURE_CONTROL0_LOG_MAX_ANISO           0x00000030
#          define NV097_SET_TEXTURE_CONTROL0_LOG_MAX_ANISO_0      0x00000000
#          define NV097_SET_TEXTURE_CONTROL0_LOG_MAX_ANISO_1      0x00000001<<4
#          define NV097_SET_TEXTURE_CONTROL0_LOG_MAX_ANISO_2      0x00000002<<4
#          define NV097_SET_TEXTURE_CONTROL0_LOG_MAX_ANISO_3      0x00000003<<4
...
#          define NV097_SET_TEXTURE_FILTER_CONVOLUTION_KERNEL_QUINCUNX       0x00000001<<13
#          define NV097_SET_TEXTURE_FILTER_CONVOLUTION_KERNEL_GAUSSIAN_3     0x00000002<<13
#       define NV097_SET_TEXTURE_FILTER_MIN                       0x00FF0000
#          define NV097_SET_TEXTURE_FILTER_MIN_BOX_LOD0           0x00000001<<16
#          define NV097_SET_TEXTURE_FILTER_MIN_TENT_LOD0          0x00000002<<16
#          define NV097_SET_TEXTURE_FILTER_MIN_BOX_NEARESTLOD     0x00000003<<16
#          define NV097_SET_TEXTURE_FILTER_MIN_TENT_NEARESTLOD    0x00000004<<16
#          define NV097_SET_TEXTURE_FILTER_MIN_BOX_TENT_LOD       0x00000005<<16
#          define NV097_SET_TEXTURE_FILTER_MIN_TENT_TENT_LOD      0x00000006<<16
#          define NV097_SET_TEXTURE_FILTER_MIN_CONVOLUTION_2D_LOD0 0x00000007<<16
#       define NV097_SET_TEXTURE_FILTER_MAG                       0x0F000000
#          define NV097_SET_TEXTURE_FILTER_MAG_BOX_LOD0           0x00000001<<24
#          define NV097_SET_TEXTURE_FILTER_MAG_TENT_LOD0          0x00000002<<24
#          define NV097_SET_TEXTURE_FILTER_MAG_CONVOLUTION_2D_LOD0 0x00000004<<24
...
#       define NV097_SET_COMBINER_COLOR_OCW_BLUETOALPHA_AB_AB_DST_ENABLE 1<<19
...
#           define NV097_SET_COMBINER_COLOR_OCW_OP_NOSHIFT          0<<15
#           define NV097_SET_COMBINER_COLOR_OCW_OP_NOSHIFT_BIAS     1<<15
#           define NV097_SET_COMBINER_COLOR_OCW_OP_SHIFTLEFTBY1     2<<15
#           define NV097_SET_COMBINER_COLOR_OCW_OP_SHIFTLEFTBY1_BIAS 3<<15
#           define NV097_SET_COMBINER_COLOR_OCW_OP_SHIFTLEFTBY2     4<<15
#           define NV097_SET_COMBINER_COLOR_OCW_OP_SHIFTRIGHTBY1    6<<15
