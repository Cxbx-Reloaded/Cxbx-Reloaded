...
typedef struct NV097KelvinPrimitive {
	...
	union {
		...
		struct {
			...
			float SetFogParamsScale;    //0x000009C4 // fogTableMode == D3DFOG_NONE or D3DFOG_LINEAR  NV097_SET_FOG_MODE_V_LINEAR, fogTableMode == D3DFOG_EXP -fogTableDensity * (1.0f / (2.0f * 5.5452f)), fogTableMode == D3DFOG_EXP2 -fogTableDensity * (1 / (2 * sqrt(5.5452))
