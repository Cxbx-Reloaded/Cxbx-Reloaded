...
LOGRENDER_TYPE_and_PTR(FILETIME)
{
	return os
...
LOGRENDER_TYPE_and_PTR(LARGE_INTEGER)
{
	return os 
		LOGRENDER_MEMBER(QuadPart);
}

LOGRENDER_TYPE_and_PTR(LAUNCH_DATA_HEADER)
{
	return os
...
LOGRENDER_TYPE_and_PTR(LAUNCH_DATA_PAGE)
{
	return os
...
LOGRENDER_TYPE_and_PTR(MM_STATISTICS)
{
	return os
...
LOGRENDER_TYPE_and_PTR(OBJECT_ATTRIBUTES)
{
	return os
...
LOGRENDER_TYPE_and_PTR(UNICODE_STRING)
{
	return os
		LOGRENDER_MEMBER(Length)
		LOGRENDER_MEMBER(MaximumLength)
