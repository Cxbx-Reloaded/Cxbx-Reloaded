...
// * EmuXACTEngineCreate
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuXACTEngineCreate)( X_XACT_RUNTIME_PARAMETERS* pParams, X_XACTEngine** ppEngine );

// ******************************************************************
// * EmuXACTEngineDoWork
// ******************************************************************
void WINAPI EMUPATCH(EmuXACTEngineDoWork)();

// ******************************************************************
// * EmuIXACTEngine_RegisterWaveBank
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_RegisterWaveBank)
(
	X_XACTEngine*		pThis,
	LPVOID				pvData,
	DWORD				dwSize,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_CreateSoundBank)
(
	X_XACTEngine*		pThis,
	LPVOID				pvData,
	DWORD				dwSize,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_DownloadEffectsImage)
(
	X_XACTEngine*		pThis,
	PVOID				pvData,
	DWORD				dwSize,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_CreateSoundSource)
(
	X_XACTEngine*		pThis,
	DWORD				dwFlags,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_EnableHeadphones)
(
	X_XACTEngine*		pThis,
	BOOL				fEnabled
);
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_SetListenerPosition)
(
	X_XACTEngine*	pThis,
	float			x,
	float			y, 
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_SetListenerVelocity)
(
	X_XACTEngine*	pThis,
	float			x,
	float			y, 
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_SetMasterVolume)
(
	X_XACTEngine*	pThis,
    WORD			wCategory,
    LONG			lVolume
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_CommitDeferredSettings)(X_XACTEngine* pThis);

// ******************************************************************
// * EmuIXACTSoundBank_GetSoundCueIndexFromFriendlyName
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTSoundBank_GetSoundCueIndexFromFriendlyName)
(
	X_XACTEngine*		pThis,
	PCSTR				pFriendlyName,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTSoundBank_Play)
(
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTSoundBank_Stop)
(
	X_XACTSoundBank*	pThis,
	DWORD				dwSoundCueIndex,
	DWORD				dwFlags,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTSoundSource_SetPosition)
(
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTSoundSource_SetVelocity)
(
	X_XACTSoundSource*	pThis,
    FLOAT				x,
    FLOAT				y,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_GetNotification)
(
	X_XACTEngine*					pThis,
    PCXACT_NOTIFICATION_DESCRIPTION pNotificationDesc,
...
// ******************************************************************
HRESULT WINAPI EMUPATCH(EmuIXACTEngine_UnRegisterWaveBank)
(
	X_XACTEngine*	pThis,
    X_XACTWaveBank*	pWaveBank
);
