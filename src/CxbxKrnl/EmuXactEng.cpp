...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuXACTEngineCreate)
(
...
// * EmuXACTEngineDoWork
// ******************************************************************
void WINAPI XTL::EMUPATCH(EmuXACTEngineDoWork)()
{
	LOG_FUNC();
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_RegisterWaveBank)
(
	X_XACTEngine*		pThis,
	LPVOID				pvData,
	DWORD				dwSize,
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_CreateSoundBank)
(
	X_XACTEngine*		pThis,
	LPVOID				pvData,
	DWORD				dwSize,
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_DownloadEffectsImage)
(
	X_XACTEngine*		pThis,
	PVOID				pvData,
	DWORD				dwSize,
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_CreateSoundSource)
(
	X_XACTEngine*		pThis,
	DWORD				dwFlags,
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_EnableHeadphones)
(
	X_XACTEngine*		pThis,
	BOOL				fEnabled
)
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_SetListenerPosition)
(
	X_XACTEngine*	pThis,
	float			x,
	float			y, 
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_SetListenerVelocity)
(
	X_XACTEngine*	pThis,
	float			x,
	float			y, 
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_SetMasterVolume)
(
	X_XACTEngine*	pThis,
    WORD			wCategory,
    LONG			lVolume
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_CommitDeferredSettings)
(
	X_XACTEngine* pThis
)
{
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTSoundBank_GetSoundCueIndexFromFriendlyName)
(
	X_XACTEngine*		pThis,
	PCSTR				pFriendlyName,
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTSoundBank_Play)
(
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTSoundBank_Stop)
(
	X_XACTSoundBank*	pThis,
	DWORD				dwSoundCueIndex,
	DWORD				dwFlags,
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTSoundSource_SetPosition)
(
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTSoundSource_SetVelocity)
(
	X_XACTSoundSource*	pThis,
    FLOAT				x,
    FLOAT				y,
...
// ******************************************************************
HRESULT WINAPI XTL::EMUPATCH(EmuIXACTEngine_GetNotification)
(
	X_XACTEngine*					pThis,
    PCXACT_NOTIFICATION_DESCRIPTION pNotificationDesc,
