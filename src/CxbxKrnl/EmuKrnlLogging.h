...
LOGRENDER_HEADER(EXCEPTION_DISPOSITION);
...
LOGRENDER_HEADER(XC_VALUE_INDEX);
...
LOGRENDER_HEADER_and_PTR(FILETIME);
...
LOGRENDER_HEADER_and_PTR(LARGE_INTEGER);
