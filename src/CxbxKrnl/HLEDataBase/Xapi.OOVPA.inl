...
OOVPATable XAPILIB_OOVPAV2[] = {
	...
	REGISTER_OOVPAS(XID_fCloseDevice, XREF, 3911, 4242, 4627, 4928, 5558),
	REGISTER_OOVPAS(XInitDevices, PATCH, 3911, 5233),
	REGISTER_OOVPAS(XInputClose, PATCH, 3911, 5558),
	REGISTER_OOVPAS(XInputGetCapabilities, PATCH, 3911, 4242, 4831, 5233, 5558),
	REGISTER_OOVPAS(XInputGetDeviceDescription, PATCH, 5344),
	REGISTER_OOVPAS(XInputGetState, PATCH, 3911, 4134, 4242, 4928, 5558),
