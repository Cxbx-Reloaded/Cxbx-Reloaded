...
// ******************************************************************
OOVPA_NO_XREF(D3DDevice_BeginVisibilityTest, 4432, 7 ) 
        { 0x07, 0x8B },
        { 0x0A, 0x46 },
        { 0x13, 0xC7 },
        { 0x16, 0x17 },
...
// ******************************************************************
OOVPA_NO_XREF(D3DDevice_EndVisibilityTest, 4432, 7)
        { 0x0B, 0x8B },
        { 0x16, 0x5E },
        { 0x22, 0x07 },
        { 0x2E, 0x00 },
...
OOVPATable D3D8_4432[]  {
	...
	REGISTER_OOVPA(D3DDevice_BeginVisibilityTest, 4432, PATCH),
	REGISTER_OOVPA(D3DDevice_EndVisibilityTest, 4432, PATCH),
