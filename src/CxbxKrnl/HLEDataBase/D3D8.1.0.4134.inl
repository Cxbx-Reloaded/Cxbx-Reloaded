...
OOVPA_NO_XREF(D3DDevice_SetTransform, 4134, 11)
        ...
        { 0x16, 0x8D }, // (Offset,Value)-Pair #2
        { 0x17, 0xBC }, // (Offset,Value)-Pair #3
        { 0x18, 0x19 }, // (Offset,Value)-Pair #4

        // D3DDevice_SetTransform+0x24 : repe movsd
        { 0x24, 0xF3 }, // (Offset,Value)-Pair #8
        { 0x25, 0xA5 }, // (Offset,Value)-Pair #6

        // D3DDevice_SetTransform+0x78 : fld [edx+0x3C]
        { 0x78, 0xD9 }, // (Offset,Value)-Pair #7
        { 0x79, 0x42 }, // (Offset,Value)-Pair #8
        { 0x7A, 0x3C }, // (Offset,Value)-Pair #9

        // D3DDevice_SetTransform+0x92 : jmp +0x10
        { 0x92, 0xEB }, // (Offset,Value)-Pair #10
        { 0x93, 0x10 }, // (Offset,Value)-Pair #11
OOVPA_END;
...
OOVPA_NO_XREF(D3DDevice_SetVerticalBlankCallback, 4134, 12)
        ...
        { 0x0C, 0x2C }, // (Offset,Value)-Pair #9 // 28 vs 2C
...
OOVPA_NO_XREF(D3DDevice_SetSwapCallback, 4134, 12)
        ...
        { 0x0A, 0x89 }, // (Offset,Value)-Pair #7
        { 0x0B, 0x81 }, // (Offset,Value)-Pair #8
        { 0x0C, 0x28 }, // (Offset,Value)-Pair #9 // 28 vs 2C
        { 0x0D, 0x24 }, // (Offset,Value)-Pair #10
