...
OOVPATable DSound_OOVPAV2[] = {
    ...
    REGISTER_OOVPAS(CMcpxBuffer_SetCurrentPosition, XREF, 3936, 4039, 4134, 5558, 5788),
    REGISTER_OOVPAS(CMcpxBuffer_Stop, XREF, 4134, 4242), // NOTE: ?Stop@CMcpxBuffer@DirectSound@@QAEJK@Z
    ...
    REGISTER_OOVPAS(CMcpxVoiceClient_SetEG, XREF, 4039, 4627),
    REGISTER_OOVPAS(CMcpxVoiceClient_SetFilter, XREF, 4039, 4134, 5344, 5558),
    REGISTER_OOVPAS(CMcpxVoiceClient_SetI3DL2Source, XREF, 3936),
    REGISTER_OOVPAS(CMcpxVoiceClient_SetLFO, XREF, 4039, 4627),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetConeOrientation, XREF, 3936, 4039, 4134, 5344),
    REGISTER_OOVPAS(CDirectSoundVoice_SetConeOutsideVolume, XREF, 3936, 4039, 4134, 4361, 5344),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetEG, XREF, 4039),
    REGISTER_OOVPAS(CDirectSoundVoice_SetFilter, XREF, 4039),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetLFO, XREF, 4039),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetPosition, XREF, 3936, 4039, 4134, 4627, 5344, 5558),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetVelocity, XREF, 3936, 4039, 4134, 5344),
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_GetCurrentPosition, XREF, 3936, 4039, 4134, 5558),
    REGISTER_OOVPAS(CDirectSoundBuffer_GetStatus, XREF, 3936, 4134, 4721),
    REGISTER_OOVPAS(CDirectSoundBuffer_Lock, XREF, 3936, 4039, 4134),
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_SetConeOrientation, XREF, 3936, 4039, 4134),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetConeOutsideVolume, XREF, 3936, 4039, 4134),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetCurrentPosition, XREF, 3936, 4039, 4134, 5558, 5788),
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_SetEG, XREF, 4039, 4627),
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_SetLFO, XREF, 4039, 4627),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetLoopRegion, XREF, 4039, 4134, 5558),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetMaxDistance, XREF, 3936, 4039, 4134, 5344, 5788),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetMinDistance, XREF, 3936, 4039, 4134, 5344, 5788),
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_SetOutputBuffer, XREF, 4039, 4627),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetPitch, XREF, 4039, 4134),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetPlayRegion, XREF, 3936, 4039, 4361, 5558),
    REGISTER_OOVPAS(CDirectSoundBuffer_SetPosition, XREF, 4039, 3936, 4134, 5558),
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_SetVelocity, XREF, 3936, 4039, 4134, 5558),
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_StopEx, XREF, 4039, 4361),
    ...
    REGISTER_OOVPAS(IDirectSoundBuffer_SetEG, PATCH, 3911),
    REGISTER_OOVPAS(IDirectSoundBuffer_SetFilter, PATCH, 3911),
    ...
    REGISTER_OOVPAS(IDirectSoundBuffer_SetLFO, PATCH, 3911),
