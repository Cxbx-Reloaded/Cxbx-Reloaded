...
OOVPATable DSound_OOVPAV2[] = {
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_SetFormat, XREF, 4361, 5558),
    ...
    REGISTER_OOVPAS(CDirectSoundStream_SetFormat, PATCH, 4361),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetFormat, XREF, 4361, 4721, 5558),
    ...
    REGISTER_OOVPAS(IDirectSoundBuffer_SetFormat, PATCH, 4361, 5558),
