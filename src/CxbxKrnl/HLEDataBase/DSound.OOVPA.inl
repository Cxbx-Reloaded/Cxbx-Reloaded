...
OOVPATable DSound_OOVPAV2[] = {
    ...
    REGISTER_OOVPAS(CDirectSoundStream_SetAllParameters, PATCH, 3911, 4134),
    ...
    REGISTER_OOVPAS(CDirectSound_SetPosition, XREF, 3911, 4134, 4627, 5344, 5558), // TODO: Find a cure for laziness... (from 4134's comment)
    ...
    REGISTER_OOVPAS(IDirectSoundStream_SetConeOrientation, PATCH, 3911),
    ...
    REGISTER_OOVPAS(IDirectSoundStream_SetMaxDistance, PATCH, 3911),
    REGISTER_OOVPAS(IDirectSoundStream_SetMinDistance, PATCH, 3911),
    REGISTER_OOVPAS(IDirectSoundStream_SetPosition, PATCH, 3911),
