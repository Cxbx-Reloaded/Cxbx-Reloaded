...
OOVPATable DSound_OOVPAV2[] = {
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetI3DL2Source, XREF, 3911, 4134, 5344, 5558),
    ...
    REGISTER_OOVPAS(CDirectSound_DownloadEffectsImage, XREF, 3911),
    ...
    REGISTER_OOVPAS(CDirectSound_SetI3DL2Listener, XREF, 3911, 4134, 5344, 5558),
    ...
    REGISTER_OOVPAS(CDirectSound_SetVelocity, XREF, 3911, 4134, 4627, 5344, 5558),
    ...
    REGISTER_OOVPAS(IDirectSoundBuffer_SetI3DL2Source, PATCH, 3911, 4134, 5558),
    ...
    REGISTER_OOVPAS(IDirectSoundStream_SetVelocity, PATCH, 3911),
