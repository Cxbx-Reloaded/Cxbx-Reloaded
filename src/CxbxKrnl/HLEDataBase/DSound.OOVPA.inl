...
OOVPATable DSound_OOVPAV2[] = {
    ...
    REGISTER_OOVPAS(CDirectSoundBuffer_SetBufferData, XREF, 4039, 4134, 5558, 5788),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetFrequency, XREF, 4039, 4134),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetPitch, XREF, 4039),
    ...
    REGISTER_OOVPAS(CDirectSoundVoice_SetVolume, XREF, 4039, 4134, 5233),
    ...
    REGISTER_OOVPAS(CDirectSound_SetDistanceFactor, XREF, 4039, 4134, 4627, 5344, 5558),
    ...
    REGISTER_OOVPAS(CDirectSound_SetRolloffFactor, XREF, 4039, 4134, 5344, 5558, 5788, 5849),
    ...
    REGISTER_OOVPAS(DirectSoundDoWorkA, XREF, 3936, 4039),
