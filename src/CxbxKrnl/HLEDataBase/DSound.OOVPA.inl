...
OOVPATable DSound_OOVPAV2[] = {
    ...
    REGISTER_OOVPAS(CDirectSoundStream_SetEG, PATCH, 4039),
    REGISTER_OOVPAS(CDirectSoundStream_SetFilter, PATCH, 4039),
    ...
    REGISTER_OOVPAS(CDirectSoundStream_SetLFO, PATCH, 4039),
