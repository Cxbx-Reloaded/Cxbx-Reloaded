...
constexpr DWORD X_D3DTSIGN_RUNSIGNED = 0;
constexpr DWORD X_D3DTSIGN_GSIGNED = 0x40000000;
constexpr DWORD X_D3DTSIGN_GUNSIGNED = 0;
constexpr DWORD X_D3DTSIGN_BSIGNED = 0x80000000;
constexpr DWORD X_D3DTSIGN_BUNSIGNED = 0;
constexpr DWORD X_D3DTSIGN_ASIGNED = 0x10000000;
constexpr DWORD X_D3DTSIGN_AUNSIGNED = 0;
