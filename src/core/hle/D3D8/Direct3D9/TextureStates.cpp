...
TextureStateInfo CxbxTextureStateInfo[] = {
    { "D3DTSS_ADDRESSU",                true,   XTL::D3DSAMP_ADDRESSU },
    { "D3DTSS_ADDRESSV",                true,   XTL::D3DSAMP_ADDRESSV },
    { "D3DTSS_ADDRESSW",                true,   XTL::D3DSAMP_ADDRESSW },
    { "D3DTSS_MAGFILTER",               true,   XTL::D3DSAMP_MAGFILTER },
    { "D3DTSS_MINFILTER",               true,   XTL::D3DSAMP_MINFILTER },
    { "D3DTSS_MIPFILTER",               true,   XTL::D3DSAMP_MIPFILTER },
    { "D3DTSS_MIPMAPLODBIAS",           true,   XTL::D3DSAMP_MIPMAPLODBIAS },
    { "D3DTSS_MAXMIPLEVEL",             true,   XTL::D3DSAMP_MAXMIPLEVEL },
    { "D3DTSS_MAXANISOTROPY",           true,   XTL::D3DSAMP_MAXANISOTROPY },
    { "D3DTSS_COLORKEYOP",              false,  0 },
    { "D3DTSS_COLORSIGN",               false,  0 },
    { "D3DTSS_ALPHAKILL",               false,  0 },
    { "D3DTSS_COLOROP",                 false,  XTL::D3DTSS_COLOROP },
    { "D3DTSS_COLORARG0",               false,  XTL::D3DTSS_COLORARG0 },
    { "D3DTSS_COLORARG1",               false,  XTL::D3DTSS_COLORARG1 },
    { "D3DTSS_COLORARG2",               false,  XTL::D3DTSS_COLORARG2 },
    { "D3DTSS_ALPHAOP",                 false,  XTL::D3DTSS_ALPHAOP },
    { "D3DTSS_ALPHAARG0",               false,  XTL::D3DTSS_ALPHAARG0 },
    { "D3DTSS_ALPHAARG1",               false,  XTL::D3DTSS_ALPHAARG1 },
    { "D3DTSS_ALPHAARG2",               false,  XTL::D3DTSS_ALPHAARG2 },
    { "D3DTSS_RESULTARG",               false,  XTL::D3DTSS_RESULTARG },
    { "D3DTSS_TEXTURETRANSFORMFLAGS",   false,  XTL::D3DTSS_TEXTURETRANSFORMFLAGS },
    { "D3DTSS_BUMPENVMAT00",            false,  XTL::D3DTSS_BUMPENVMAT00 },
    { "D3DTSS_BUMPENVMAT01",            false,  XTL::D3DTSS_BUMPENVMAT01 },
    { "D3DTSS_BUMPENVMAT11",            false,  XTL::D3DTSS_BUMPENVMAT11 },
    { "D3DTSS_BUMPENVMAT10",            false,  XTL::D3DTSS_BUMPENVMAT10 },
    { "D3DTSS_BUMPENVLSCALE",           false,  XTL::D3DTSS_BUMPENVLSCALE },
    { "D3DTSS_BUMPENVLOFFSET",          false,  XTL::D3DTSS_BUMPENVLOFFSET },
    { "D3DTSS_TEXCOORDINDEX",           false,  XTL::D3DTSS_TEXCOORDINDEX },
    { "D3DTSS_BORDERCOLOR",             true,   XTL::D3DSAMP_BORDERCOLOR },
...
{
    switch (Value) {
        case XTL::X_D3DTOP_DISABLE: return XTL::D3DTOP_DISABLE;
        case XTL::X_D3DTOP_SELECTARG1: return XTL::D3DTOP_SELECTARG1;
        case XTL::X_D3DTOP_SELECTARG2: return XTL::D3DTOP_SELECTARG2;
        case XTL::X_D3DTOP_MODULATE: return XTL::D3DTOP_MODULATE;
        case XTL::X_D3DTOP_MODULATE2X: return XTL::D3DTOP_MODULATE2X;
        case XTL::X_D3DTOP_MODULATE4X: return XTL::D3DTOP_MODULATE4X;
        case XTL::X_D3DTOP_ADD: return XTL::D3DTOP_ADD;
        case XTL::X_D3DTOP_ADDSIGNED: return XTL::D3DTOP_ADDSIGNED;
        case XTL::X_D3DTOP_ADDSIGNED2X: return XTL::D3DTOP_ADDSIGNED2X;
        case XTL::X_D3DTOP_SUBTRACT: return XTL::D3DTOP_SUBTRACT;
        case XTL::X_D3DTOP_ADDSMOOTH: return XTL::D3DTOP_ADDSMOOTH;
        case XTL::X_D3DTOP_BLENDDIFFUSEALPHA: return XTL::D3DTOP_BLENDDIFFUSEALPHA;
        case XTL::X_D3DTOP_BLENDCURRENTALPHA: return XTL::D3DTOP_BLENDCURRENTALPHA;
        case XTL::X_D3DTOP_BLENDTEXTUREALPHA: return XTL::D3DTOP_BLENDTEXTUREALPHA;
        case XTL::X_D3DTOP_BLENDFACTORALPHA: return XTL::D3DTOP_BLENDFACTORALPHA;
        case XTL::X_D3DTOP_BLENDTEXTUREALPHAPM: return XTL::D3DTOP_BLENDTEXTUREALPHAPM;
        case XTL::X_D3DTOP_PREMODULATE: return XTL::D3DTOP_PREMODULATE;
        case XTL::X_D3DTOP_MODULATEALPHA_ADDCOLOR: return XTL::D3DTOP_MODULATEALPHA_ADDCOLOR;
        case XTL::X_D3DTOP_MODULATECOLOR_ADDALPHA: return XTL::D3DTOP_MODULATECOLOR_ADDALPHA;
        case XTL::X_D3DTOP_MODULATEINVALPHA_ADDCOLOR: return XTL::D3DTOP_MODULATEINVALPHA_ADDCOLOR;
        case XTL::X_D3DTOP_MODULATEINVCOLOR_ADDALPHA: return XTL::D3DTOP_MODULATEINVCOLOR_ADDALPHA;
        case XTL::X_D3DTOP_DOTPRODUCT3: return XTL::D3DTOP_DOTPRODUCT3;
        case XTL::X_D3DTOP_MULTIPLYADD: return XTL::D3DTOP_MULTIPLYADD;
        case XTL::X_D3DTOP_LERP: return XTL::D3DTOP_LERP;
        case XTL::X_D3DTOP_BUMPENVMAP: return XTL::D3DTOP_BUMPENVMAP;
        case XTL::X_D3DTOP_BUMPENVMAPLUMINANCE: return XTL::D3DTOP_BUMPENVMAPLUMINANCE;
    }

    EmuLog(LOG_LEVEL::WARNING, "Unsupported D3DTOP Value (%d)", Value);
    return XTL::D3DTOP_DISABLE;
    ...
    for (int XboxStage = 0; XboxStage < XTL::X_D3DTS_STAGECOUNT; XboxStage++) {
        ...
        for (int StateIndex = XTL::X_D3DTSS_FIRST; StateIndex <= XTL::X_D3DTSS_LAST; StateIndex++) {
            ...
            if (CxbxTextureStateInfo[State].IsSamplerState) {
                g_pD3DDevice->SetSamplerState(HostStage, (XTL::D3DSAMPLERSTATETYPE)CxbxTextureStateInfo[State].PC, Value);
            } else {
                g_pD3DDevice->SetTextureStageState(HostStage, (XTL::D3DTEXTURESTAGESTATETYPE)CxbxTextureStateInfo[State].PC, Value);
            }
        }
