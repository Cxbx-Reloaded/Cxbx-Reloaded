...
#include "core\hle\D3D8\Rendering\EmuD3D8.h" // For LPDIRECTDRAWSURFACE7
#include "core\hle\D3D8\Rendering\Backend_D3D11.h" // D3D11 backend state/functions
#include "core\hle\D3D8\Rendering\Shader.h" // For InitShaderHotloading
