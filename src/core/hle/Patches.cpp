...
std::map<const std::string, const xbox_patch_t> g_PatchTable = {
	...
	//PATCH_ENTRY("D3DDevice_SetVertexShader", xbox::EMUPATCH(D3DDevice_SetVertexShader), PATCH_HLE_D3D),     //Patches for SetVertexShader() are only to setup global xbox pushbuffer variables.
	...
	PATCH_ENTRY("CreateStandAloneSurface", xbox::EMUPATCH(CreateStandAloneSurface), PATCH_HLE_D3D),
	PATCH_ENTRY("D3DTexture_GetSurfaceLevel", xbox::EMUPATCH(D3DTexture_GetSurfaceLevel), PATCH_HLE_D3D),
	PATCH_ENTRY("D3DTexture_GetSurfaceLevel2", xbox::EMUPATCH(D3DTexture_GetSurfaceLevel2), PATCH_HLE_D3D),
	PATCH_ENTRY("D3DResource_Register", xbox::EMUPATCH(D3DResource_Register), PATCH_HLE_D3D),
	...
	PATCH_ENTRY("XGSetSurfaceHeader", xbox::EMUPATCH(XGSetSurfaceHeader), PATCH_HLE_D3D),
	//PATCH_ENTRY("XGSetTextureHeader", xbox::EMUPATCH(XGSetTextureHeader), PATCH_HLE_D3D),
	//PATCH_ENTRY("XGSetVertexBufferHeader", xbox::EMUPATCH(XGSetVertexBufferHeader), PATCH_HLE_D3D),
