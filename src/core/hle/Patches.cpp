...
std::map<const std::string, const xbox_patch_t> g_PatchTable = {
	...
	PATCH_ENTRY("CreateStandAloneSurface", EMUPATCH(CreateStandAloneSurface), PATCH_HLE_D3D),
	...
	PATCH_ENTRY("XGSetSurfaceHeader", EMUPATCH(XGSetSurfaceHeader), PATCH_HLE_D3D),
