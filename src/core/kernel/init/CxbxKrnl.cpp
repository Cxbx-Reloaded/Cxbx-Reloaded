...
#include "core/kernel/support/EmuFilePaths.hpp"
...
static bool CxbxrKrnlSetupCdRom0Path(int BootFlags, int lastFind, std::filesystem::path relative_path)
{
...
//  Debug child processes using https://marketplace.visualstudio.com/items?itemName=GreggMiskelly.MicrosoftChildProcessDebuggingPowerTool
	...
	bool isEmuDisk = CxbxrKrnlSetupCdRom0Path(BootFlags, lastFind, relative_path);
